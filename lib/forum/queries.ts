...
const POST_SELECT =
  "id,source,source_id,title,url,author,category,subcategory,university,university_id,language,upvotes,comment_count,upvotes_count,downvotes_count,comments_count,views_count,slug,ai_summary,ai_summary_kr,ai_title_en,ai_summary_en,ai_content_en,ai_tags,source_created_at,created_at,is_published";
